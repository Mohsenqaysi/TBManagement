...
public class AdminActivity extends AppCompatActivity {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Patients, PatientsViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Patients, PatientsViewHolder>(
            ...
            @Override
            protected void populateViewHolder(PatientsViewHolder viewHolder, final Patients model, final int position) {
...
//                viewHolder.setImage(model.getImage());
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("currentChild", getRef(position).getKey().toString());
